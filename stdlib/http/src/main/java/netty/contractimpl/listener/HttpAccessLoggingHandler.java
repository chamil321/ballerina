...
public class HttpAccessLoggingHandler extends LoggingHandler {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        if (msg instanceof HttpRequest) {
            ...
            if (httpRequest.headers().contains(netty.contract.Constants.HTTP_X_FORWARDED_FOR)) {
                // can contain multiple IPs for proxy chains. the first ip is our client.
                String proxyChain = httpRequest.headers().get(netty.contract.Constants.HTTP_X_FORWARDED_FOR);
