...
public class InboundMessageHolder {
    private netty.message.HttpCarbonMessage inboundMsg;
    private long lastReadWriteTime;
    private netty.contractimpl.Http2OutboundRespListener http2OutboundRespListener;

    public InboundMessageHolder(netty.message.HttpCarbonMessage inboundMsgOrPushResponse) {
    ...
    public netty.contractimpl.Http2OutboundRespListener getHttp2OutboundRespListener() {
