...
public interface ListenerState {
     ...
     */
    void writeOutboundResponseHeaders(netty.contractimpl.Http2OutboundRespListener http2OutboundRespListener,
     ...
     * @throws Http2Exception if an error occurs while writing
     */
    void writeOutboundResponseBody(netty.contractimpl.Http2OutboundRespListener http2OutboundRespListener,
     ...
     * @throws Http2Exception if an error occurs while writing
     */
    void writeOutboundPromise(netty.contractimpl.Http2OutboundRespListener http2OutboundRespListener, Http2PushPromise pushPromise)
     ...
     */
    void handleStreamTimeout(netty.contract.ServerConnectorFuture serverConnectorFuture, ChannelHandlerContext ctx,
