...
public class SendingHeaders implements ListenerState {
    ...
    public SendingHeaders(netty.contractimpl.Http2OutboundRespListener http2OutboundRespListener,
        ...
        try {
            serverConnectorFuture.notifyErrorListener(
                    new netty.contract.exceptions.ServerConnectorException(
                            Constants.IDLE_TIMEOUT_TRIGGERED_WHILE_WRITING_OUTBOUND_RESPONSE_HEADERS));
