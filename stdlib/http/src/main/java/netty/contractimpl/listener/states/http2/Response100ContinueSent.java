...
public class Response100ContinueSent implements ListenerState {
    ...
    @Override
    public void writeOutboundPromise(netty.contractimpl.Http2OutboundRespListener http2OutboundRespListener, Http2PushPromise pushPromise)
            throws Http2Exception {
        ...
        channelFuture.addListener(writeOperationPromise -> {
            ...
            if (throwable != null) {
                if (throwable instanceof ClosedChannelException) {
                    throwable = new IOException(Constants.REMOTE_CLIENT_CLOSED_WHILE_WRITING_100_CONTINUE_RESPONSE);
                }
