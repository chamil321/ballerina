    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        if (msg instanceof ByteBuf) {
            ...
            if (ByteBufUtil.equals(inputData, inputData.readerIndex(), clientPrefaceString,
                ...
                Util.safelyRemoveHandlers(pipeline, netty.contract.Constants.HTTP_SERVER_CODEC);
                pipeline.addBefore(
                        netty.contract.Constants.HTTP2_UPGRADE_HANDLER,
                ...
                Util.safelyRemoveHandlers(pipeline, netty.contract.Constants.HTTP2_UPGRADE_HANDLER,
                                          netty.contract.Constants.HTTP_COMPRESSOR, Constants.HTTP_TRACE_LOG_HANDLER);
            }
