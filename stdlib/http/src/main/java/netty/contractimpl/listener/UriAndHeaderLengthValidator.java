        ...
        if (msg instanceof HttpRequest) {
            if (ctx.channel().isActive()) {
                ...
                if (cause instanceof TooLongFrameException) {
                    if (cause.getMessage().contains(netty.contract.Constants.REQUEST_HEADER_TOO_LARGE)) {
                        netty.contractimpl.common.Util.sendAndCloseNoEntityBodyResp(ctx, HttpResponseStatus.REQUEST_ENTITY_TOO_LARGE,
