...
public interface ListenerState {
     ...
     *
     * @param inboundRequestMsg     {@link netty.message.HttpCarbonMessage} which represents the inbound message
     * @param inboundRequestHeaders {@link HttpRequest} which is received at source handler
     */
    void readInboundRequestHeaders(netty.message.HttpCarbonMessage inboundRequestMsg, HttpRequest inboundRequestHeaders);

    /**
     * Read entity body of inbound request.
     *
     * @param inboundRequestEntityBody which represents the inbound Http content
     * @throws netty.contract.exceptions.ServerConnectorException if an error occurs while notifying to server connector future
     */
     ...
     *
     * @param outboundResponseMsg {@link netty.message.HttpCarbonMessage} which represents the outbound message
     * @param httpContent         the initial content of the entity body
     */
    void writeOutboundResponseHeaders(netty.message.HttpCarbonMessage outboundResponseMsg, HttpContent httpContent);
     ...
     */
    void handleAbruptChannelClosure(netty.contract.ServerConnectorFuture serverConnectorFuture);
