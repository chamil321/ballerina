...
public class ReceivingEntityBody implements ListenerState {
    ...
    ReceivingEntityBody(ListenerReqRespStateManager listenerReqRespStateManager, netty.message.HttpCarbonMessage inboundRequestMsg,
    ...
    public void writeOutboundResponseBody(HttpOutboundRespListener outboundResponseListener,
        ...
        if (Util.getHttpResponseStatus(outboundResponseMsg).code() != HttpResponseStatus.CONTINUE.code()) {
            respondToIncompleteRequest(sourceHandler.getInboundChannelContext().channel(), outboundResponseListener,
                                       ...
                                       netty.contract.Constants.REMOTE_CLIENT_CLOSED_WHILE_READING_INBOUND_REQUEST_BODY);
        }
    }

    @Override
    public void handleAbruptChannelClosure(netty.contract.ServerConnectorFuture serverConnectorFuture) {
        handleIncompleteInboundMessage(inboundRequestMsg, netty.contract.Constants.REMOTE_CLIENT_CLOSED_WHILE_READING_INBOUND_REQUEST_BODY);
    }
    ...
    public ChannelFuture handleIdleTimeoutConnectionClosure(ServerConnectorFuture serverConnectorFuture,
        ...
        ByteBuf responseBody =
                copiedBuffer(netty.contract.Constants.IDLE_TIMEOUT_TRIGGERED_WHILE_READING_INBOUND_REQUEST_BODY, CharsetUtil.UTF_8);
    ...
    private boolean isDiffered(HttpCarbonMessage sourceReqCmsg) {
        ...
        return sourceReqCmsg.getProperty(netty.contract.Constants.HTTP_RESOURCE) != null;
    }
}
