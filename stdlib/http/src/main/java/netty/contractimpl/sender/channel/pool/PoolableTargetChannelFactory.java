...
public class PoolableTargetChannelFactory implements PoolableObjectFactory {
    ...
    private final netty.contract.config.SenderConfiguration senderConfiguration;
    private final BootstrapConfiguration bootstrapConfiguration;
    private final ConnectionManager connectionManager;

    PoolableTargetChannelFactory(EventLoopGroup eventLoopGroup, Class eventLoopClass, netty.contractimpl.common.HttpRoute httpRoute,
                                        netty.contract.config.SenderConfiguration senderConfiguration,
