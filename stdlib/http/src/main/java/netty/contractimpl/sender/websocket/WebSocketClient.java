...
import netty.contract.websocket.ClientHandshakeFuture;
import netty.contract.websocket.WebSocketClientConnectorConfig;
...
public class WebSocketClient {
    ...
    private final netty.contract.websocket.WebSocketClientConnectorConfig connectorConfig;
    ...
    public ClientHandshakeFuture handshake() {
        ...
        try {
            ...
            if (!netty.contract.Constants.WS_SCHEME.equalsIgnoreCase(scheme) && !netty.contract.Constants.WSS_SCHEME.equalsIgnoreCase(scheme)) {
            ...
            final boolean ssl = netty.contract.Constants.WSS_SCHEME.equalsIgnoreCase(scheme);
                ...
                new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel socketChannel) throws SSLException {
                        if (sslConfig != null) {
                            ...
                            socketChannel.pipeline().addLast(netty.contract.Constants.SSL_COMPLETION_HANDLER,
    ...
    private void configureHandshakePipeline(ChannelPipeline pipeline) {
        ...
        pipeline.addLast(netty.contract.Constants.WEBSOCKET_CLIENT_HANDSHAKE_HANDLER, clientHandshakeHandler);
    }
    ...
    private int getPort(URI uri) {
        ...
        if (port == -1) {
            switch (scheme) {
            case netty.contract.Constants.WS_SCHEME:
                return 80;
