...
package netty.contractimpl.sender.websocket;
...
import netty.message.DefaultListener;
...
public class WebSocketClientHandshakeHandler extends ChannelInboundHandlerAdapter {
    ...
    private netty.message.HttpCarbonResponse httpCarbonResponse;
    ...
    public netty.message.HttpCarbonResponse getHttpCarbonResponse() {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        try {
            ...
            channel.pipeline().addLast(netty.contract.Constants.WEBSOCKET_FRAME_HANDLER, inboundFrameHandler);
    ...
    private netty.message.HttpCarbonResponse setUpCarbonMessage(ChannelHandlerContext ctx, HttpResponse msg) {
        netty.message.HttpCarbonResponse carbonResponse = new HttpCarbonResponse(msg, new DefaultListener(ctx));
        carbonResponse.setProperty(netty.contract.Constants.DIRECTION, Constants.DIRECTION_RESPONSE);
