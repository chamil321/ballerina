...
import netty.contractimpl.common.certificatevalidation.RevocationVerificationManager;
...
public class OCSPStaplingHandler extends OcspClientHandler {
    ...
    protected boolean verify(ChannelHandlerContext ctx, ReferenceCountedOpenSslEngine engine)
        ...
        if (staple == null) {
            ...
            netty.contractimpl.common.certificatevalidation.RevocationVerificationManager
                    revocationVerifier = new RevocationVerificationManager(
                    Constants.CACHE_DEFAULT_ALLOCATED_SIZE, Constants.CACHE_DEFAULT_DELAY_MINS);
