...
public interface SenderState {
     ...
     *
     * @param httpOutboundRequest {@link netty.message.HttpCarbonMessage} which represents the outbound message
     */
    void writeOutboundRequestHeaders(netty.message.HttpCarbonMessage httpOutboundRequest);
     ...
     */
    void writeOutboundRequestEntity(netty.message.HttpCarbonMessage httpOutboundRequest, HttpContent httpContent);
     ...
     * @param inboundResponseMsg {@link netty.message.HttpCarbonMessage} which represents the inbound message
     ...
     */
    void handleAbruptChannelClosure(TargetHandler targetHandler, netty.contract.HttpResponseFuture httpResponseFuture);
