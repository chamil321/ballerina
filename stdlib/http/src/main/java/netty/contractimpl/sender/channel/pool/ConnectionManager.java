...
package netty.contractimpl.sender.channel.pool;
...
public class ConnectionManager {
     ...
     */
    public TargetChannel borrowTargetChannel(netty.contractimpl.common.HttpRoute httpRoute, SourceHandler sourceHandler,
                                             Http2SourceHandler http2SourceHandler,
                                             netty.contract.config.SenderConfiguration senderConfig, BootstrapConfiguration bootstrapConfig,
    ...
    private GenericObjectPool getTrgHlrPoolFromGlobalPool(netty.contractimpl.common.HttpRoute httpRoute, netty.contract.config.SenderConfiguration senderConfig,
    ...
    private GenericObjectPool getTrgHlrPoolFromGlobalPoolWithSrcPool(netty.contractimpl.common.HttpRoute httpRoute,
                                                                     netty.contract.config.SenderConfiguration senderConfig,
                                                                     BootstrapConfiguration bootstrapConfig,
