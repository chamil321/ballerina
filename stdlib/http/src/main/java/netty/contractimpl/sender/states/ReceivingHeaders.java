...
public class ReceivingHeaders implements SenderState {
    ...
    public void readInboundResponseHeaders(TargetHandler targetHandler, HttpResponse httpInboundResponse) {
        ...
        if (targetHandler.getHttpResponseFuture() != null) {
            netty.message.HttpCarbonMessage inboundResponseMsg = targetHandler.getInboundResponseMsg();
    ...
    public void handleAbruptChannelClosure(TargetHandler targetHandler, netty.contract.HttpResponseFuture httpResponseFuture) {
        handleIncompleteInboundMessage(targetHandler.getInboundResponseMsg(),
                                       netty.contract.Constants.REMOTE_SERVER_CLOSED_WHILE_READING_INBOUND_RESPONSE_HEADERS);
    }
    ...
    public void handleIdleTimeoutConnectionClosure(TargetHandler targetHandler,
        ...
        handleIncompleteInboundMessage(targetHandler.getInboundResponseMsg(),
                                       netty.contract.Constants.IDLE_TIMEOUT_TRIGGERED_WHILE_READING_INBOUND_RESPONSE_HEADERS);
    }
}
