...
import netty.contractimpl.sender.channel.pool.PoolConfiguration;
...
public class Http2ConnectionManager {
    ...
    private netty.contractimpl.sender.channel.pool.PoolConfiguration poolConfiguration;
     ...
     */
    public void addHttp2ClientChannel(EventLoop eventLoop, netty.contractimpl.common.HttpRoute httpRoute, Http2ClientChannel http2ClientChannel) {
     ...
     */
    public Http2ClientChannel borrowChannel(Http2SourceHandler http2SrcHandler, netty.contractimpl.common.HttpRoute httpRoute) {
     ...
     */
    void returnClientChannel(netty.contractimpl.common.HttpRoute httpRoute, Http2ClientChannel http2ClientChannel) {
     ...
     */
    void removeClientChannel(netty.contractimpl.common.HttpRoute httpRoute, Http2ClientChannel http2ClientChannel) {
        EventLoopPool.PerRouteConnectionPool perRouteConnectionPool = fetchPerRoutePool(httpRoute,
                                                                                        http2ClientChannel.getChannel()
                                                                                            .eventLoop());
        if (perRouteConnectionPool != null) {
    ...
    private EventLoopPool.PerRouteConnectionPool fetchPerRoutePool(netty.contractimpl.common.HttpRoute httpRoute,
                                                                   EventLoop eventLoop) {
        String key = generateKey(httpRoute);
