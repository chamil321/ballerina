...
public class TargetChannel {
    ...
    private final netty.contractimpl.common.HttpRoute httpRoute;
    ...
    public TargetChannel(HttpClientChannelInitializer httpClientChannelInitializer, ChannelFuture channelFuture,
                         netty.contractimpl.common.HttpRoute httpRoute, ConnectionAvailabilityFuture connectionAvailabilityFuture) {
    ...
    public void configTargetHandler(netty.message.HttpCarbonMessage httpCarbonMessage, HttpResponseFuture httpInboundResponseFuture) {
    ...
    public void writeContent(HttpCarbonMessage httpOutboundRequest) {
        ...
        BackPressureHandler backpressureHandler = netty.contractimpl.common.Util.getBackPressureHandler(targetHandler.getContext());
        netty.contractimpl.common.Util.setBackPressureListener(httpOutboundRequest, backpressureHandler, httpOutboundRequest.getSourceContext());
