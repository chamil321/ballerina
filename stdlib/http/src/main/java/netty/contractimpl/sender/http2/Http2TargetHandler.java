...
package netty.contractimpl.sender.http2;
...
import netty.contractimpl.sender.states.http2.SendingEntityBody;
import netty.contractimpl.sender.states.http2.SendingHeaders;
...
public class Http2TargetHandler extends ChannelDuplexHandler {
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) {
        ...
        } else if (msg instanceof netty.message.Http2Reset) {
            netty.message.Http2Reset resetMsg = (netty.message.Http2Reset) msg;
    ...
    /**
     * Sets the {@link org.wso2.transport.http.netty.contractimpl.sender.http2.Http2ClientChannel}.
     *
    ...
    /**
     * Gets the {@link org.wso2.transport.http.netty.contractimpl.sender.http2.Http2ClientChannel}.
     *
    ...
    public class Http2RequestWriter {
        ...
        netty.message.HttpCarbonMessage httpOutboundRequest;
        ...
        public netty.message.HttpCarbonMessage getHttpOutboundRequest() {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        if (msg instanceof netty.message.Http2HeadersFrame) {
            onHeaderRead(ctx, (netty.message.Http2HeadersFrame) msg);
        } else if (msg instanceof netty.message.Http2DataFrame) {
            onDataRead(ctx, (netty.message.Http2DataFrame) msg);
        } else if (msg instanceof netty.message.Http2PushPromise) {
            onPushPromiseRead(ctx, (netty.message.Http2PushPromise) msg);
        } else if (msg instanceof netty.message.Http2Reset) {
            onResetRead((netty.message.Http2Reset) msg);
        }
    }
    ...
    private Http2MessageStateContext initHttp2MessageContext(OutboundMsgHolder outboundMsgHolder) {
        ...
        if (http2MessageStateContext == null) {
            http2MessageStateContext = new Http2MessageStateContext();
            http2MessageStateContext.setSenderState(new netty.contractimpl.sender.states.http2.RequestCompleted(this, null));
