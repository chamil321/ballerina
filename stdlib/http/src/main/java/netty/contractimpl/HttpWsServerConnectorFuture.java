...
public class HttpWsServerConnectorFuture extends DefaultWebSocketConnectorFuture implements ServerConnectorFuture {
    ...
    @Override
    public void notifyHttpListener(HttpCarbonMessage httpMessage) throws
                                                                  netty.contract.exceptions.ServerConnectorException {
        if (httpConnectorListener == null) {
            throw new netty.contract.exceptions.ServerConnectorException(HTTP_CONNECTOR_LISTENER_IS_NOT_SET);
        }
    ...
    @Override
    public void notifyHttpListener(Http2PushPromise pushPromise) throws
                                                                 netty.contract.exceptions.ServerConnectorException {
        if (httpConnectorListener == null) {
            throw new netty.contract.exceptions.ServerConnectorException(HTTP_CONNECTOR_LISTENER_IS_NOT_SET);
        }
    ...
    @Override
    public void notifyErrorListener(Throwable cause) throws netty.contract.exceptions.ServerConnectorException {
        if (httpConnectorListener == null) {
