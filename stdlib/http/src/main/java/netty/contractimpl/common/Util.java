...
package netty.contractimpl.common;
...
import netty.contract.exceptions.ConfigurationException;
...
public class Util {
     ...
     * @throws netty.contract.exceptions.ConfigurationException for invalid configurations
     */
    public static boolean isKeepAlive(KeepAliveConfig keepAliveConfig, HttpCarbonMessage outboundRequestMsg)
            throws netty.contract.exceptions.ConfigurationException {
    ...
    /**
     * Use this method to get the {@link org.wso2.transport.http.netty.contractimpl.common.BackPressureHandler} in the pipeline. This requires a {@link
     * ChannelHandlerContext} of a handler in the pipeline.
     *
     * @param channelContext the channelContext which will be used to obtain the {@link org.wso2.transport.http.netty.contractimpl.common.BackPressureHandler} in the
     *                       pipeline.
     * @return The {@link org.wso2.transport.http.netty.contractimpl.common.BackPressureHandler} in the pipeline.
     */
