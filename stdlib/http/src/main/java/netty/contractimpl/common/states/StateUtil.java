...
import netty.contractimpl.listener.states.SendingHeaders;
...
public class StateUtil {
    ...
    public static boolean checkChunkingCompatibility(String httpVersion, ChunkConfig chunkConfig) {
        return netty.contractimpl.common.Util.isVersionCompatibleForChunking(httpVersion) || Util
    ...
    public static ChannelFuture sendRequestTimeoutResponse(ChannelHandlerContext ctx, HttpResponseStatus status,
        ...
        if (httpVersion == netty.contract.Constants.HTTP_1_0) {
    ...
    public static void handleIncompleteInboundMessage(netty.message.HttpCarbonMessage inboundRequestMsg, String errorMessage) {
    ...
    public static void addTrailerHeaderIfPresent(netty.message.HttpCarbonMessage outboundResponseMsg) {
