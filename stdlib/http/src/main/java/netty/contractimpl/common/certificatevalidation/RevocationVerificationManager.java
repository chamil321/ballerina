...
package netty.contractimpl.common.certificatevalidation;

import netty.contractimpl.common.certificatevalidation.crl.CRLCache;
import netty.contractimpl.common.certificatevalidation.crl.CRLVerifier;
...
import netty.contractimpl.common.certificatevalidation.pathvalidation.CertificatePathValidator;
...
public class RevocationVerificationManager {
     ...
     * @throws org.wso2.transport.http.netty.contractimpl.common.certificatevalidation.CertificateVerificationException Occurs when certificate fails to be validated from both OCSP and CRL.
    ...
    public boolean verifyRevocationStatus(javax.security.cert.X509Certificate[] peerCertificates)
        ...
        netty.contractimpl.common.certificatevalidation.ocsp.OCSPCache ocspCache = OCSPCache.getCache();
        ocspCache.init(cacheSize, cacheDelayMins);
        netty.contractimpl.common.certificatevalidation.crl.CRLCache crlCache = CRLCache.getCache();
        ...
        for (RevocationVerifier verifier : verifiers) {
            try {
                netty.contractimpl.common.certificatevalidation.pathvalidation.CertificatePathValidator pathValidator = new CertificatePathValidator(convertedCertificates, verifier);
     ...
     * @throws org.wso2.transport.http.netty.contractimpl.common.certificatevalidation.CertificateVerificationException If an error occurs while converting certificates
     * from java to javax
     */
