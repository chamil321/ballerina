...
package netty.contractimpl.common.certificatevalidation.crl;

import netty.contractimpl.common.MBeanRegistrar;
import netty.contractimpl.common.certificatevalidation.cache.CacheController;
import netty.contractimpl.common.certificatevalidation.cache.CacheManager;
import netty.contractimpl.common.certificatevalidation.cache.ManageableCache;
import netty.contractimpl.common.certificatevalidation.cache.ManageableCacheValue;
...
public class CRLCache implements ManageableCache {
    ...
    private volatile netty.contractimpl.common.certificatevalidation.cache.CacheManager cacheManager;
        ...
        if (cacheManager == null) {
            synchronized (CRLCache.class) {
                if (cacheManager == null) {
                    ...
                    netty.contractimpl.common.certificatevalidation.cache.CacheController
                            mbean = new CacheController(cache, cacheManager);
     ...
     */
    public synchronized netty.contractimpl.common.certificatevalidation.cache.ManageableCacheValue getNextCacheValue() {
