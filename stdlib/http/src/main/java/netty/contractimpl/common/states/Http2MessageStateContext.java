...
import netty.contractimpl.listener.states.http2.ListenerState;
import netty.contractimpl.sender.states.http2.SenderState;
...
public class Http2MessageStateContext {
    ...
    private netty.contractimpl.listener.states.http2.ListenerState listenerState;
    private netty.contractimpl.sender.states.http2.SenderState senderState;
     ...
     */
    public void setListenerState(netty.contractimpl.listener.states.http2.ListenerState state) {
     ...
     */
    public netty.contractimpl.sender.states.http2.SenderState getSenderState() {
        return senderState;
    }
