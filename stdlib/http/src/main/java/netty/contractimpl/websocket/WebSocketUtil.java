...
import netty.contractimpl.websocket.message.DefaultWebSocketBinaryMessage;
import netty.contractimpl.websocket.message.DefaultWebSocketControlMessage;
import netty.contractimpl.websocket.message.DefaultWebSocketTextMessage;
...
public class WebSocketUtil {
    ...
    public static netty.contract.websocket.WebSocketControlMessage getWebSocketControlMessage(WebSocketFrame webSocketFrame,
