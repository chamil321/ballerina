...
/**
 * Default implementation of {@link netty.contract.websocket.WebSocketConnection}.
 */
public class DefaultWebSocketConnection implements WebSocketConnection {
    ...
    public void startReadingFrames() {
        ...
        if (pipeline.get(netty.contract.Constants.MESSAGE_QUEUE_HANDLER) != null) {
            ctx.pipeline().remove(netty.contract.Constants.MESSAGE_QUEUE_HANDLER);
        }
    ...
    public void stopReadingFrames() {
        ...
        ChannelPipeline pipeline = ctx.pipeline();
        if (pipeline.get(netty.contract.Constants.MESSAGE_QUEUE_HANDLER) == null) {
            ctx.pipeline().addBefore(netty.contract.Constants.WEBSOCKET_FRAME_HANDLER, netty.contract.Constants.MESSAGE_QUEUE_HANDLER,
    ...
    public ChannelFuture pushText(String text, boolean finalFrame) {
        if (continuationFrameType == netty.contract.websocket.WebSocketFrameType.BINARY) {
