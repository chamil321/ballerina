...
public class HttpTransportContextHolder {
    ...
    private Map<String, netty.contract.config.ListenerConfiguration> listenerConfigurations = new HashMap<>();
    ...
    public netty.contract.config.ListenerConfiguration getListenerConfiguration(String id) {
