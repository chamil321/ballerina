...
public class ServerRemoteFlowControlListener implements Http2RemoteFlowController.Listener {
    ...
    private ConcurrentHashMap<Integer, netty.contractimpl.Http2OutboundRespListener.ResponseWriter> responseWriters =
    ...
    public void writabilityChanged(Http2Stream stream) {
        netty.contractimpl.Http2OutboundRespListener.ResponseWriter responseWriter = responseWriters.get(stream.id());
    ...
    public void addResponseWriter(netty.contractimpl.Http2OutboundRespListener.ResponseWriter responseWriter) {
