...
import netty.contractimpl.DefaultHttpResponseFuture;
import netty.contractimpl.HttpWsServerConnectorFuture;
...
public class HttpCarbonMessage {
    ...
    private Map<String, Object> properties = new HashMap<>(netty.contract.Constants.HTTP_CARBON_MESSAGE_PROPERTIES_MAP_DEFAULT_SIZE);
    ...
    private final netty.contractimpl.DefaultHttpResponseFuture
    ...
    public HttpCarbonMessage(HttpMessage httpMessage, Listener contentListener) {
        ...
        setBlockingEntityCollector(new BlockingEntityCollector(netty.contract.Constants.ENDPOINT_TIMEOUT));
     ...
     */
    public netty.contract.HttpResponseFuture getHttpOutboundRespStatusFuture() {
        return httpOutboundRespStatusFuture;
    }

    public netty.contract.HttpResponseFuture respond(HttpCarbonMessage httpCarbonMessage) throws
                                                                                          netty.contract.exceptions.ServerConnectorException {
     ...
     * @throws netty.contract.exceptions.ServerConnectorException if there is an error occurs while doing the operation
     */
    public netty.contract.HttpResponseFuture pushResponse(HttpCarbonMessage httpCarbonMessage, Http2PushPromise pushPromise)
            throws netty.contract.exceptions.ServerConnectorException {
    ...
    /**
     * Returns the {@link org.wso2.transport.http.netty.message.FullHttpMessageFuture} which notifies {@link org.wso2.transport.http.netty.message.FullHttpMessageListener} when the complete
     * content of the {@link HttpCarbonMessage} is accumulated. Should never remove content listener for HTTP/2.
     *
     * @return the default implementation of the {@link org.wso2.transport.http.netty.message.FullHttpMessageFuture}.
     */
     ...
     * {@link org.wso2.transport.http.netty.message.FullHttpMessageFuture} if available.
     */
