...
public class HttpMessageDataStreamer {
    ...
    public InputStream getInputStream() {
        ...
        if (contentEncodingHeader != null) {
            ...
            try {
                if (contentEncodingHeader.equalsIgnoreCase(netty.contract.Constants.ENCODING_GZIP)) {
                    return new GZIPInputStream(createInputStreamIfNull());
                } else if (contentEncodingHeader.equalsIgnoreCase(netty.contract.Constants.ENCODING_DEFLATE)) {
