...
public class SslConfiguration {
    ...
    public void setKeyStoreFile(String keyStoreFile) {
        sslConfig.setKeyStore(new File(netty.contractimpl.common.Util.substituteVariables(keyStoreFile)));
    }
    ...
    public void setTrustStoreFile(String trustStoreFile) {
        sslConfig.setTrustStore(new File(netty.contractimpl.common.Util.substituteVariables(trustStoreFile)));
    }
    ...
    public void setServerKeyFile(String serverKeyFile) {
        sslConfig.setServerKeyFile(new File(netty.contractimpl.common.Util.substituteVariables(serverKeyFile)));
    }

    public void setServerCertificates(String serverCertificates) {
        sslConfig.setServerCertificates(new File(netty.contractimpl.common.Util.substituteVariables(serverCertificates)));
    }

    public void setClientKeyFile(String clientKeyFile) {
        sslConfig.setClientKeyFile(new File(netty.contractimpl.common.Util.substituteVariables(clientKeyFile)));
    }

    public void setClientCertificates(String clientCertificates) {
        sslConfig.setClientCertificates(new File(netty.contractimpl.common.Util.substituteVariables(clientCertificates)));
    }

    public void setServerTrustCertificates(String serverTrustCertificates) {
        sslConfig.setServerTrustCertificates(new File(
                netty.contractimpl.common.Util.substituteVariables(serverTrustCertificates)));
    }
