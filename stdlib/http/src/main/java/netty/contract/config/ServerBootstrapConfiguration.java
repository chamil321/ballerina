...
public class ServerBootstrapConfiguration {
    ...
    public ServerBootstrapConfiguration(Map<String, Object> properties) {
        ...
        socketReuse = netty.contractimpl.common.Util.getBooleanProperty(
                properties, Constants.SERVER_BOOTSTRAP_SO_REUSE, false);

        soBackLog = netty.contractimpl.common.Util.getIntProperty(properties, Constants.SERVER_BOOTSTRAP_SO_BACKLOG, 100);
