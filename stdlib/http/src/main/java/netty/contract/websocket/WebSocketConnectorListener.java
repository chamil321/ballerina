...
package netty.contract.websocket;
...
public interface WebSocketConnectorListener {
     ...
     *
     * @param binaryMessage {@link org.wso2.transport.http.netty.contract.websocket.WebSocketBinaryMessage} to process binary messages.
     */
     ...
     *
     * @param webSocketConnection {@link org.wso2.transport.http.netty.contract.websocket.WebSocketConnection} which gets closed.
     */
     ...
     *
     * @param webSocketConnection {@link org.wso2.transport.http.netty.contract.websocket.WebSocketConnection} which causes the error.
