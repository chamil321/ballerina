...
public interface HttpConnectorFuture {
     ...
     * @throws netty.contract.exceptions.ServerConnectorException if any error occurred during the notification.
     */
    void notifyHttpListener(HttpCarbonMessage httpMessage) throws netty.contract.exceptions.ServerConnectorException;
     ...
     * @throws netty.contract.exceptions.ServerConnectorException in case of failure
     */
    void notifyHttpListener(Http2PushPromise pushPromise) throws netty.contract.exceptions.ServerConnectorException;

    /**
     * Notify error messages to the listener.
     *
     * @param cause Reason for the error.
     * @throws netty.contract.exceptions.ServerConnectorException if any error occurred during the error notification.
     */
